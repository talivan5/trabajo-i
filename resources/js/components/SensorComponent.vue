        ...
        <table class="table">
                ...
                <tbody>
                    <tr v-for="(sensor, $index) in sensors" :key="sensor.id">
                        ...
                        <td>
                            <!-- crear boton editar -->
                            <button type="button" class="btn btn-warning" @click="abrirModal('editar',sensor)">Editar</button>
                            <!-- crear boton eliminar -->
                            <button type="button" class="btn btn-danger" @click="eliminarUsuario(sensor.id)">Eliminar</button>
                        </td>
                    </tr>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="sensor.descripcion">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button v-if="esEdit" class="btn btn-primary" @click="agregarSensor(sensor)">Registrar</button>
                    <button v-else class="btn btn-primary" @click="editarSensor(sensor)">Actualizar</button>
                </div>
                </div>
            </div>
        </div>
